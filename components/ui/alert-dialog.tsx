...
>(({ className, ...props }, ref) => {
  ...
  return (
    <AlertDialogPrimitive.Overlay
      className={cn(
        'z-50 bg-black/60 flex justify-center items-center p-2 absolute top-0 right-0 bottom-0 left-0',
...
>(({ className, children, ...props }, ref) => {
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn('z-50 bg-black/60 flex justify-center items-center p-2', className)}
      {...props}
      ref={ref}
      asChild
    >
